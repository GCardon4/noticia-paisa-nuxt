        ...
        <div class="row items-center justify-between">
          ...
          <div class="col-12 col-md-6 text-center text-md-right">
            ...
            <div class="social-links">
              <a href="https://www.facebook.com/share/1CZfxzFLUK/gi" target="_blank" rel="noopener noreferrer" class="social-link">
              ...
              <a href="https://www.youtube.com/@noticiapaisa" target="_blank" rel="noopener noreferrer" class="social-link">
                <img src="/social-icons/icon-youtube-white.svg" alt="YouTube" class="footer-icon"/>
              </a>
              <a href="https://www.tiktok.com/@noticiapaisaoficial?_r=1&_t=ZS-91kdnJqpYIe" target="_blank" rel="noopener noreferrer" class="social-link">
                <img src="/social-icons/icon-tiktok-white.svg" alt="TikTok" class="footer-icon"/>
              </a>
              <a href="https://t.me/noticiapaisaoficial1" target="_blank" rel="noopener noreferrer" class="social-link">
                <img src="/social-icons/icon-telegram-white.svg" alt="Telegram" class="footer-icon"/>
              </a>
              <a href="https://wa.me/+573153459039" target="_blank" rel="noopener noreferrer" class="social-link">
